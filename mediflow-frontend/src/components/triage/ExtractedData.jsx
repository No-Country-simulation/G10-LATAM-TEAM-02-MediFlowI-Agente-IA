...
import { FaUser, FaUserMd, FaFileMedical, FaStethoscope, FaPills, FaFlask } from "react-icons/fa";
...
const ExtractedData = ({ data = {}, clasificacion = {} }) => {
            ...
            <div className="card-body">
              ...
              <ul className="list-unstyled mb-0">
                <li className="mb-2">
                  ...
                  <span className="badge bg-primary text-white fs-7">{sanitize(clasificacion.tipo_documento)}</span>
                </li>
                <li>
