> **Programa ONE · Grupo 10** | Agente Autónomo para Triaje, Extracción y Enrutamiento de Documentos Clínicos  
...
* Demostración práctica cubriendo al menos **tres casos de prueba**:
  1. Flujo estándar aprobado,
  2. Caso con prioridad de urgencia médica y
  3. Caso ambiguo derivado a auditoría humana.
